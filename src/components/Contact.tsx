          ...
          <div className="bg-card p-6 rounded-lg shadow-md animate-slide-up">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:alex@example.com" className="hover:text-accent transition-colors">alex@example.com</a>
              </div>
              <div className="flex items-center gap-3">
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-4">
                <a href="#" className="h-10 w-10 rounded-full bg-accent/10 flex items-center justify-center hover:bg-accent hover:text-white transition-colors">
